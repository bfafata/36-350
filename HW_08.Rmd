...
```{r linewidth=80}
readLines("https://raw.githubusercontent.com/bfafata/36-350/main/README.md",warn=FALSE)
```
...
source_url("https://raw.githubusercontent.com/bfafata/36-350/main/dark_and_stormy.R")
```
...
```{r linewidth=80}
source_url("https://raw.githubusercontent.com/bfafata/36-350/main/dark_and_stormy.R")
source_url("https://raw.githubusercontent.com/bfafata/36-350/new_branch/dark_and_stormy.R")
```
...
```{r linewidth=80}
source_url("https://raw.githubusercontent.com/bfafata/36-350-Fork/main/check_mark.R")
```
---
...
```{r linewidth=80}
f = function(letter) {
  if ( typeof(letter) != "string") stop("input must be a string")
  if ( nchar(letter) != 1) 
    {
  warning("only the first character is used") 
...
test_that(desc = "Test for value", expect_equal(f("a"),0))
test_that(desc = "Test for improper input",       expect_error(f(1)))
test_that(desc = "Test for expected output length (1)",     expect_length(f("a"),1))
test_that(desc = "Test that output is numeric",             expect_type(f("a"),"double"))
test_that(desc = "Test for string of length greater than 1",expect_warning(f("aa")))
test_that(desc = "Test for value of string length greater than 1", expect_equal(f("asdfgjk"),0))
...
# FILL ME IN
f = function(letter) {
  if ( typeof(letter) != "character") stop("input must be a string")
  if ( nchar(letter) != 1) 
    {
  warning("only the first character is used") 
  letter=substr(letter,1,1)
